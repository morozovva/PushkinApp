...
/**
 * The type Museum data repository.
 */
public class MuseumDataRepository {

    /**
     * Instantiates a new Museum data repository.
     */
   public MuseumDataRepository(){
   }

    /**
     * The Museum catalog item list.
     */
